...
// Types
type ShapeType = 'triangle' | 'square' | 'pentagon' | 'circle' | 'star';
...
interface RotatingPatternData {
    sequence: Shape[]; // 3 items
    options: Shape[]; // 4 items (1 correct)
    ruleDescription: string; // Optional debug/hint
}

interface RotatingPatternSolution {
    correctOptionIndex: number;
}

type RotatingPatternInput = number | null; // Index of selected option
...
export const RotatingPatternEngine: PuzzleEngine<RotatingPatternData, RotatingPatternSolution, RotatingPatternInput> = {
