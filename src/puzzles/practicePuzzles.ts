...
export interface PracticePuzzle {
    ...
    data: any; // Generic data for all puzzle types
    solution: any; // Generic solution
    initialBoard?: (number | null)[][]; // Deprecated, kept for backward compat if needed (but we will migrate all)
}
